...
(`gcovr 8.4`, `gcov (GCC) 14.3.0`, nrfutil, west); locked `nix-nrf-dev`
supplies `nrfutil sdk-manager` 1.16.1 from a versioned Nordic archive with a
fixed Nix SHA-256. The exact NCS v3.3.0 SDK and `911f4c5c26`
