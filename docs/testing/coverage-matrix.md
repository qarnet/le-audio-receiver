...
| Coverage | 1 | coverage (test-coverage.sh default mode: rebuilds the 32 twister + 5 exec suites with CONFIG_COVERAGE=y, enforces the committed baseline) |
...
> "Current suite inventory" table above** (58 children at P4 acceptance,
> 59 after P5).
