...
`docs/development/user-pairing-control-p8-results.md`.  The current
authoritative state is the FR1 packaging closeout (2026-08-09):
canonical gate **63 PASS / 0 FAIL / 63 TOTAL** (35 twister + 5 exec-only
+ 20 Python + coverage + matrix + BSim), coverage population **36**
...
`STATUS.md` and `docs/development/firmware-release-fr1-results.md`.
All
